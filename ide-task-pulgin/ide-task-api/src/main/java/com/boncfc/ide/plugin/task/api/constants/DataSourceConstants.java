...
public class DataSourceConstants {
    ...
    public static final String COM_CLOUDERA_IMPALA_JDBC_DRIVER = "com.cloudera.impala.jdbc41.Driver";
    ...
    public static final String IMPALA_VALIDATION_QUERY = "select 1";
