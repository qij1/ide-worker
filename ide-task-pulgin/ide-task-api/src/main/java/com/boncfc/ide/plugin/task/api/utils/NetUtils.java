...
public class NetUtils {
    private static final String IDE_SCHEDULER_NETWORK_PRIORITY_STRATEGY =
            "ide.scheduler.network.priority.strategy";
    ...
    private static List<NetworkInterface> filterByNetworkPriority(List<NetworkInterface> validNetworkInterfaces) {
        ...
        String networkPriority = PropertyUtils.getString(IDE_SCHEDULER_NETWORK_PRIORITY_STRATEGY,
