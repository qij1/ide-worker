...
import com.boncfc.ide.plugin.task.api.config.ImmutablePriorityPropertyDelegate;
import com.boncfc.ide.plugin.task.api.config.ImmutablePropertyDelegate;
import com.boncfc.ide.plugin.task.api.config.ImmutableYamlDelegate;
...
public class PropertyUtils {
    ...
    private final ImmutablePriorityPropertyDelegate propertyDelegate =
            new ImmutablePriorityPropertyDelegate(
                    new ImmutablePropertyDelegate(Constants.COMMON_PROPERTIES_PATH));
