...
public class SqlBinds {
    ...
    private final Map<Integer, JobInstanceParams> paramsMap;

    public SqlBinds(String sql, Map<Integer, JobInstanceParams> paramsMap) {
        this.sql = sql;
    ...
    public Map<Integer, JobInstanceParams> getParamsMap() {
        return paramsMap;
    }
}
