...
public class WorkerTaskExecutorHolder {
    ...
    public static void put(WorkerTaskExecutor workerTaskExecutor) {
        ...
        if (workerTaskExecutorMap.containsKey(jobInstId)) {
            throw new IllegalArgumentException("JobInstance: " + jobInstId + " already exists");
        }
        workerTaskExecutorMap.put(jobInstId, workerTaskExecutor);
    }
