...
import com.boncfc.ide.server.worker.config.ImmutablePropertyDelegate;
import com.boncfc.ide.server.worker.config.ImmutableYamlDelegate;
...
public class PropertyUtils {
    ...
    private final ImmutablePriorityPropertyDelegate propertyDelegate =
            new ImmutablePriorityPropertyDelegate(
                    ...
                    new ImmutableYamlDelegate(Constants.REMOTE_LOGGING_YAML_PATH));
